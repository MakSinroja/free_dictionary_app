package developers.guru.bottomNavigationBar.utils
...
import developers.guru.bottomNavigationBar.ui.BottomNavigationBar

/**
 * Created by Maulik V. Sinroja on 2021-09-11 16:56.
 */
class AccessibleExploreByTouchHelper(
    private val host: BottomNavigationBar,
    private val bottomBarItems: List<BottomNavigationBarItem>,
    ...
    override fun onPopulateNodeForVirtualView(
        ...
        node.className = BottomNavigationBarItem::class.simpleName
