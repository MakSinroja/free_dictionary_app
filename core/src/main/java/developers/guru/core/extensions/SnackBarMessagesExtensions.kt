...
import developers.guru.core.R

/**
 * Created by Maulik V. Sinroja on 2021-09-08 16:50.
 */
...
fun showSnackBarView(view: View, text: String, drawable: Int) {
    ...
    sbTextView.setTextColor(ContextCompat.getColor(view.context, android.R.color.white))
    sbTextView.maxLines = 3
